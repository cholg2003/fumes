...
import { ArrowLeft, Plus, Edit, Trash2, Building2, Users, UserPlus, UsersRound, FileText, Receipt, Printer } from 'lucide-react';
...
const AdminCRUD = () => {
  ...
  const handleMemberDelete = async (serialNumber) => {
    if (!window.confirm(`Delete member "${serialNumber}"? This will fail if the member has bills.`)) return;
    try {
