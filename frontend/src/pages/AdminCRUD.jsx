                    ...
                    <tr>
                      <th className="text-center p-3 text-sm font-semibold w-12">
                        <Checkbox
                          ...
                          onCheckedChange={() => toggleSelectAll(paginatedHospitals, selectedHospitals, setSelectedHospitals, 'hospital_name')}
                        />
                      </th>
              ...
              <CardContent>
                ...
                {filteredFamilies.length > ITEMS_PER_PAGE && (
                  <Pagination
                    ...
                    totalPages={getTotalPages(filteredFamilies.length)}
            ...
            <Card>
              ...
              <CardContent>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {paginatedPricelists.map((item, index) => {
                ...
                {filteredPricelists.length > ITEMS_PER_PAGE && (
                  <Pagination
                    currentPage={pricelistPage}
                    totalPages={getTotalPages(filteredPricelists.length)}
                    onPageChange={setPricelistPage}
                  />
                )}
              </CardContent>
            </Card>
