...
class StudentAccountingApp:
    def __init__(self, root):
        ...
        self.ws.append(["Admission Number", "Name", "Class", "Term", "Total Fees", "Fees Paid", "Balance"])
    ...
    def add_student(self):
        ...
        self.ws.append([admission_number, name, class_, term, total_fees, fees_paid, balance])
